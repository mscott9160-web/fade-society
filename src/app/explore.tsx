...
const styles = StyleSheet.create({ safeArea: { flex: 1, backgroundColor: '#F5F0EA' }, container: { flex: 1, padding: 20 }, title: { color: '#171717', fontSize: 32, fontWeight: '800', marginTop: 20 }, subtitle: { color: '#736C62', marginTop: 8, fontSize: 15 }, list: { gap: 10, marginTop: 24 }, barberButton: { minHeight: 84, borderRadius: 14, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E9DED0', padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, barberName: { color: '#171717', fontSize: 17, fontWeight: '800' }, barberMeta: { color: '#736C62', marginTop: 4 }, barberDetail: { color: '#736C62', marginTop: 4, fontSize: 12 }, bookText: { color: '#8A6A3A', fontWeight: '800' } });
