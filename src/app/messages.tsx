...
export default function MessagesScreen() {
  ...
  const { messages, messageLoading, messageError } = useAppStore();
  ...
  return <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}><ScrollView contentContainerStyle={styles.container}>
    ...
    {live && messageError && <Text accessibilityRole="alert" style={[styles.subtitle, { color: theme.accent }]}>Unable to load conversations: {messageError}</Text>}
